...
#define TAGGED_POINTER_STRING_HAS_A_LEGNTH(ptr) (ptr && (TAGGED_POINTER_STRING_FLAG | TAGGED_POINTER_STRING_LENGTH_FLAG))
#define TAGGED_POINTER_STRING_LENGTH_OFFSET 35
